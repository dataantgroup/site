...
export const _postTitles = [
  'LLM-DRIVEN QUADRUPED ROBOT FOR VISUALLY IMPAIRED GUIDANCE',
...
export const _descriptions = [
  `Learn robotics basics. AI concepts, and Python programming through hands-on projects with the NVIDIA JetBot. Discover real-world applications and see your code come to life!`,
